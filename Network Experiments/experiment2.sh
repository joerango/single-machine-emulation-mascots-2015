...
tc -s qdisc replace dev veth2 root handle 1:0 tbf rate 10000kbit limit 150000 burst 12000
tc -s qdisc add dev veth2 parent 1:1 handle 10: netem delay 50ms
tc -s qdisc replace dev veth3 root handle 1:0 tbf rate 10000kbit limit 150000 burst 12000
tc -s qdisc add dev veth3 parent 1:1 handle 10: netem delay 50ms
